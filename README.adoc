...
Example:
`mulefd ~/AnypointStudio/studio-workspace/mule-flow-diagrams-demo`
...
[source,bash]
----
$ JAVA_OPTS='-Xmx1024m' mulefd ~/AnypointStudio/studio-workspace/mule-flow-diagrams-demo
----
...
mulefd.bat ~/AnypointStudio/studio-workspace/mule-flow-diagrams-demo
----
